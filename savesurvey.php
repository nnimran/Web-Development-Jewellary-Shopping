...
<nav>
  ...
  $query = "INSERT INTO survey(FIRSTNAME,LASTNAME,SATISFIED,SCALE,ABOUT) VALUES ('$firstname','$lastname','$service','$rating','$source')";
  ...
  <br><br><br>
  <h1>Survey/ Poll Completed Successfully!!!</h1>
