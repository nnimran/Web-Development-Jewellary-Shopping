...
<br><br><br>
<h1>View Orders Placed Below:-</h1>
<div align="center">
<table >
<tr>
<td >First Name</td>
...
echo ($fg2);
echo("</td>");
// PS value in column two
$fg3 = OCIResult($stmt,"PS"); //"PS";
echo("<td >");
echo ($fg3);
echo("</td>");

// PAYMENTMETHOD value in column one
$fg4 = OCIResult($stmt,"PAYMENTMETHOD"); //"PAYMENTMETHOD";
echo("<td >");
echo ($fg4);
echo("</td>");
echo("</em></td>");
// PAYMENTAMOUNT value in column one
$fg5 = OCIResult($stmt,"PAYMENTAMOUNT"); //"PAYMENTAMOUNT";
echo("<td >");
echo ($fg5);
echo("</td>");
echo("</em></td>");
// PAYMENTADDRESS value in column one
$fg6 = OCIResult($stmt,"PAYMENTADDRESS"); //"PAYMENTADDRESS";
echo("<td >");
echo ($fg6);
echo("</td>");
echo("</em></td>");
